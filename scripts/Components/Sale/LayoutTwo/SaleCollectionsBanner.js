...
const ButtonLink = ({ settings }) => {
  ...
  return (
    <div className="justify-items-center lg:px-26 md:col-span-12 md:p-10 px-5 py-8">
      <div className="bg-blue-baby lg:px-10 max-w-screen-xxl mx-auto px-4 outline-blue">
        <div className="md:flex md:justify-center md:pb-2 md:pt-12">
          <div className="center font-medium font-serif lg:font-normal lg:text-8xl mb-2 md:mb-0 md:pb-0 md:pt-0 pt-12 text-6xl text-orange-burnt">
            <span>{discount}%</span>
            <span className="font-bold lg:font-medium lg:text-6xl text-4xl uppercase">ff</span>
          </div>

          <div className="center font-sans lg:pl-6 lg:pt-7 lg:text-6xl md:pl-3 md:pt-5 pb-4 text-1xl text-3xl tracking-wider">
            <span className={`${collection_hero_title_font} ${hero_title_color_1}`}>
              {collection_hero_title}
            </span>
          </div>
        </div>
